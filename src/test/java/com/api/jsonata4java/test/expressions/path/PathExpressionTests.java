...
//	private final static String TAW = "{"+TA+"}";
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            ...
            { "a.b.c", 	"{\"a\":{\"b\":{\"c\":0}}, \"x\":2}", 	null, "{"+P+": {\"a\": {"+P+":{\"b\":{"+P+":{\"c\":"+TNW+"}}}}}}", 	"1", "{\"a\":{\"b\":{\"c\":1}}, \"x\":2}", 	null},
            ...
            {"a[0][0][0]", 	"{\"a\":[[[0]]]}",			null, "{"+P+": {\"a\": {"+TA+", "+I+":{"+TA+", "+I+":{"+TA+", "+I+":"+TNW+"}}}}}", 	"1", "{\"a\":[[[1]]]}", null},
            {"a[0][1][0]", 	"{\"a\":[[[0], [0]]]}",		null, "{"+P+": {\"a\": {"+TA+", "+I+":{"+TA+", "+I+":{"+TA+", "+I+":"+TNW+"}}}}}", 	"1", "{\"a\":[[[0], [1]]]}", null},
            ...
            { "a[0][0]", "{\"a\":[]}", 					null, "{"+P+": {\"a\": {"+TA+", "+I+":{"+TA+", "+I+":"+TNW+"}}}}", null, null, PathExpressionVisitor.ERR_ARR_INDEX_OUT_OF_BOUNDS("a", 0)},
            { "a[0][0]", "{\"a\":[[]]}", 				null, "{"+P+": {\"a\": {"+TA+", "+I+":{"+TA+", "+I+":"+TNW+"}}}}", null, null, PathExpressionVisitor.ERR_ARR_INDEX_OUT_OF_BOUNDS("a[0]", 0)},
            { "a[1][2]", "{\"a\":[[0],[0,0]]}", 		null, "{"+P+": {\"a\": {"+TA+", "+I+":{"+TA+", "+I+":"+TNW+"}}}}", null, null, PathExpressionVisitor.ERR_ARR_INDEX_OUT_OF_BOUNDS("a[1]", 2)},
        // wnm3 out { "a[$index][2]", "{\"a\":[[0],[0,0]]}", 	1, 	  "{"+P+": {\"a\": {"+TA+", "+I+":{"+TA+", "+I+":"+TNW+"}}}}", null, null, PathExpressionVisitor.ERR_ARR_INDEX_OUT_OF_BOUNDS("a[1]", 2)},
            { "a[1][1].b[0][1].c", 	"{\"a\":[[], [[], {\"b\":[[{\"c\":0}]]}]]}", 	null, "{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", null, PathExpressionVisitor.ERR_ARR_INDEX_OUT_OF_BOUNDS("b[0]", 1)},
         ...
         // wnm3 out { "a[$index][2]", 	"{\"a\":[0,1]}", 	1,		"{"+P+": {\"a\":{"+TA+", "+I+":"+TNW+"}}}", 			null, null, PathExpressionVisitor.ERR_INDEX_ON_NON_ARRAY("a[1]", 2)},
            ...
            { "a[1].b", 	"{\"a\":[{\"b\":0}, {\"b\":1}, {\"b\":2}]}", 			null, "{"+P+": {\"a\":{"+TA+", "+I+":{"+P+":{\"b\":"+TNW+"}}}}}", 					"3", "{\"a\":[{\"b\":0}, {\"b\":3}, {\"b\":2}]}", 		null},
            { "a.b[1]", 	"{\"a\":{\"b\":[0,1,2]}}", 								null, "{"+P+": {\"a\":{"+P+":{\"b\":{"+TA+", "+I+":"+TNW+"}}}}}", 					"3", "{\"a\":{\"b\":[0,3,2]}}", 							null},
            { "a.b[1].c", 	"{\"a\":{\"b\":[{\"c\":0}, {\"c\":1}, {\"c\":2}]}}", 	null, "{"+P+": {\"a\":{"+P+":{\"b\":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}", 	"3", "{\"a\":{\"b\":[{\"c\":0}, {\"c\":3}, {\"c\":2}]}}", null},
            
            // nested arrays + object nesting
            { "a[0][0].b[0][0].c", 				"{\"a\":[[{\"b\":[[{\"c\":0}]]}]]}", 					null, 	"{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", "{\"a\":[[{\"b\":[[{\"c\":1}]]}]]}", 					null},
            { "a[1][0].b[0][0].c", 				"{\"a\":[[], [{\"b\":[[{\"c\":0}]]}]]}", 				null, 	"{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", "{\"a\":[[], [{\"b\":[[{\"c\":1}]]}]]}", 				null},
            { "a[1][1].b[0][0].c", 				"{\"a\":[[], [[], {\"b\":[[{\"c\":0}]]}]]}", 			null, 	"{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", "{\"a\":[[], [[], {\"b\":[[{\"c\":1}]]}]]}", 			null},
            { "a[1][1].b[1][0].c", 				"{\"a\":[[], [[], {\"b\":[[], [{\"c\":0}]]}]]}", 		null, 	"{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", "{\"a\":[[], [[], {\"b\":[[], [{\"c\":1}]]}]]}",		null},
            { "a[1][1].b[1][1].c", 				"{\"a\":[[], [[], {\"b\":[[], [[], {\"c\":0}]]}]]}", 	null, 	"{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", "{\"a\":[[], [[], {\"b\":[[], [[], {\"c\":1}]]}]]}", 	null},
         // wnm3 out { "a[$index][1].b[1][$index].c", 	"{\"a\":[[], [[], {\"b\":[[], [[], {\"c\":0}]]}]]}", 	1, 		"{"+P+": {\"a\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"b\":{"+TA+", "+I+":{"+TA+", "+I+":{"+P+":{\"c\":"+TNW+"}}}}}}}}}}", 	"1", "{\"a\":[[], [[], {\"b\":[[], [[], {\"c\":1}]]}]]}", 	null},
            ...
            { "`a b`.c[1]", "{\"a b\":{\"c\":[0,1,2]}}", 									null, "{"+P+": {\"a b\":{"+P+":{\"c\":{"+TA+", "+I+":"+TNW+"}}}}}", 	"3", "{\"a b\":{\"c\":[0,3,2]}}", 								null},
            { "`a b`[1].`c[1]`", "{\"a b\":[{\"c[1]\":0}, {\"c[1]\":1}, {\"c[1]\":2}]}", 	null, "{"+P+": {\"a b\":{"+TA+", "+I+":{"+P+":{\"c[1]\":"+TNW+"}}}}}", 	"3", "{\"a b\":[{\"c[1]\":0}, {\"c[1]\":3}, {\"c[1]\":2}]}", 	null},
