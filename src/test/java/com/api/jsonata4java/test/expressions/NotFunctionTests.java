...
public class NotFunctionTests {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{ "$not([])", "true", null }, //
				// non-empty arrays
				{ "$not([0])", "true", null }, // single member that casts to false -> true
				{ "$not([1])", "false", null }, // single member that casts to true -> false
				{ "$not([false, \"\", false, [], [0], null])", "true", null }, // all members cast to false -> true
				{ "$not([true, 1, \"a\", [1]])", "false", null }, // all members cast to true -> false
				{ "$not([false, \"\", false, [], [0], true, null])", "false", null }, // contains a member that casts to true -> false
				{ "$not([false, \"\", false, [], [1], null])", "false", null }, // // contains a member that casts to true -> false 
