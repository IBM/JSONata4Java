...
public class BooleanFunctionTests {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "$boolean()", null, null}, // jsonata 1.8.2 ERR_BAD_CONTEXT }, //
				...
				{ "$boolean([])", "false", null }, //
				{ "$boolean([0])", "false", null }, // // single member that casts to false -> true
				{ "$boolean([1])", "true", null }, // // single member that casts to true -> false
				{ "$boolean([false, '', false, [], [0], null])", "false", null }, // // all members cast to false ->
																					// true
				{ "$boolean([true, 1, 'a', [1]])", "true", null }, // // all members cast to true -> false
				{ "$boolean([false, '', false, [], [0], true, null])", "true", null }, // // contains a member that
																						// casts to true -> false
				{ "$boolean([false, '', false, [], [1], null])", "true", null }, // // contains a member that casts to
																					// true -> false
				{ "$boolean({})", "false", null }, //
				{ "$boolean({'hello':true})", "true", null }, //
				{ "$boolean({'0':false})", "true", null }, //
				{ "$boolean([9223372036854775807])", "true", null }, // // Long.MAX_VALUE
				{ "$boolean([-9223372036854775808])", "true", null }, // // Long.MIN_VALUE
				...
				{ "[]~>$boolean()", "false", null }, //
				{ "[0]~>$boolean()", "false", null }, // // single member that casts to false -> true
				{ "[1]~>$boolean()", "true", null }, // // single member that casts to true -> false
				{ "[false, '', false, [], [0], null]~>$boolean()", "false", null }, // all members cast to false -> true
				{ "[true, 1, 'a', [1]]~>$boolean()", "true", null }, // // all members cast to true -> false
				{ "[false, '', false, [], [0], true, null]~>$boolean()", "true", null }, // contains a member that casts to true -> false
				{ "[false, '', false, [], [1], null]~>$boolean()", "true", null }, // contains a member that casts to true -> false
				{ "{}~>$boolean()", "false", null }, //
				{ "{'hello':true}~>$boolean()", "true", null }, //
				{ "{'0':false}~>$boolean(      )", "true", null }, //
				{ "[9223372036854775807]~>$boolean(      )", "true", null }, // Long.MAX_VALUE
				{ "[-9223372036854775808]~>$boolean(      )", "true", null }, // Long.MIN_VALUE
