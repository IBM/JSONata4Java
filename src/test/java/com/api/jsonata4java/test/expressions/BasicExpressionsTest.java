...
//    simpleTest("$spread([1])","[1]");
   ...
   public void testExistsFunction() throws Exception {
      ...
      }
      {
         ...
         for (JsonNode valueType : new JsonNode[] { NullNode.getInstance(), new IntNode(22), BooleanNode.TRUE,
   ...
   public void testSumFunction() throws Exception {
      ...
      {
         for (String param : new String[] { "true", "false", "\"hello\"", "{}", "[[]]", "[true]", "[false]",
