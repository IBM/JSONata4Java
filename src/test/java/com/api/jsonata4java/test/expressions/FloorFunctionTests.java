...
public class FloorFunctionTests {
    ...
    private static final String ERR_MSG_ARG1_BAD_TYPE       = String.format(Constants.ERR_MSG_ARG1_BAD_TYPE, Constants.FUNCTION_FLOOR);
    private static final String ERR_MSG_ARG2_BAD_TYPE       = String.format(Constants.ERR_MSG_ARG2_BAD_TYPE, Constants.FUNCTION_FLOOR);
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
            ...
            {"$floor(-10/3.0)",                         Long.toString((long)Math.floor(-10/3.0)),                           null}, //
            {"$floor(9223372036854775807)",             Long.toString((long)Math.floor(9223372036854775807D)),              null}, // // Long.MAX_VALUE
            {"$floor(-9223372036854775808)",            Long.toString((long)Math.floor(-9223372036854775808D)),             null}, // // Long.MIN_VALUE
