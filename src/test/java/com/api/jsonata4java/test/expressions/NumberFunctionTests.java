...
public class NumberFunctionTests {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "$number()", null, ERR_BAD_CONTEXT }, //
				{ "$number({})", null, ERR_MSG_ARG1_BAD_TYPE }, //
				{ "$number({\"hello\": 1})", null, ERR_MSG_ARG1_BAD_TYPE }, //
				{ "$number([])", null, ERR_MSG_ARG1_BAD_TYPE }, //
				{ "$number([\"hello\", 1])", null, ERR_MSG_ARG1_BAD_TYPE }, //
				{ "$number('foo')", null, ERR_MSG_UNABLE_TO_CAST_FOO }, //
				{ "$number(true)", "1", null}, // jsonata 1.8.2 null, ERR_MSG_ARG1_BAD_TYPE }, //
				...
				{ "$number(0)", "0", null }, //
				{ "$number(0.0)", "0", null}, // jsonata 1.8.2 "0.0", null }, //
				{ "$number('0')", "0", null }, //
				{ "$number('0.0')", "0", null}, // jsonata 1.8.2 "0.0", null }, //
				{ "$number('1')", "1", null }, //
				{ "$number('1',\"a\")", null, ERR_MSG_ARG2_BAD_TYPE }, //
				{ "$number('1.0')", "1", null}, // jsonata 1.8.2 "1.0", null }, //
				{ "$number('1.00000')", "1", null}, // jsonata 1.8.2 "1.00000", null }, //
				{ "$number('-22.2')", "-22.2", null }, //
				{ "$number(9223372036854775807)", "9223372036854775807", null }, // // Long.MAX_VALUE
				{ "$number(-9223372036854775808)", "-9223372036854775808", null}, // jsonata 1.8.2 "-9.223372036854776E18", null }, // // Long.MIN_VALUE
				{ "$number('9223372036854775807')", "9223372036854775807", null }, // // Long.MAX_VALUE
				{ "$number('-9223372036854775808')", "-9223372036854775808", null }, // // Long.MIN_VALUE
				{ "$number(9223372036854775809)", "9223372036854775807", null}, // jsonata 1.8.2 "9.223372036854776E18", null }, //
				{ "$number(-9223372036854775809)", "-9223372036854775808", null}, // jsonata 1.8.2 "-9.223372036854776E18", null }, //
				{ "$number('9223372036854775809')", "9223372036854775807", null}, // jsonata 1.8.2 "9.223372036854776E18", null }, //
				{ "$number('-9223372036854775809')", "-9223372036854775808", null}, // jsonata 1.8.2 "-9.223372036854776E18", null }, //
				{ "$number(9223372036854775899.5)", "9223372036854775807", null }, // jsonata 1.8.2 "9.223372036854776E18", null }, //
				{ "$number(-9223372036854775899.5)", "-9223372036854775808", null }, // jsonata 1.8.2 "-9.223372036854776E18", null }, //
				{ "$number('9223372036854775899.5')", "9223372036854775807", null }, // jsonata 1.8.2 "9.223372036854776E18", null }, //
				{ "$number('-9223372036854775899.5')", "-9223372036854775808", null }, // jsonata 1.8.2 "-9.223372036854776E18", null }, //
