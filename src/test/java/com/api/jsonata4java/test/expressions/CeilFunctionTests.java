...
public class CeilFunctionTests {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
            ...
            {"$ceil(-10/3.0)",                         Long.toString((long)Math.ceil(-10/3.0)),                           null}, //
            {"$ceil(9223372036854775807)",             Long.toString((long)Math.ceil(9223372036854775807D)),              null}, // // Long.MAX_VALUE
            {"$ceil(-9223372036854775808)",            Long.toString((long)Math.ceil(-9223372036854775808D)),             null}, // // Long.MIN_VALUE
