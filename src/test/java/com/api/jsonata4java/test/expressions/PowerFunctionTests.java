...
public class PowerFunctionTests {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] { { "$power()", null, ERR_MSG_ARG1_BAD_TYPE }, //
				...
				{ "$power(0, 2)", Double.toString(Math.pow(0, 2)), null }, //
				{ "$power(0, 2)", Double.toString(Math.pow(0.0, 2)), null }, //
				...
				{ "$power(2147483647, 2)", Double.toString(Math.pow(2147483647, 2)), null }, //
				{ "$power(-2147483640, 2)", Double.toString(Math.pow(-2147483640, 2)), null }, //
				...
				{ "$power(-10/3.0, 1)", Double.toString(Math.pow(-10 / 3.0, 1)), null }, //
				{ "$power(1, 10/3.0)", Double.toString(Math.pow(1, 10 / 3.0)), null }, //
				{ "$power(1, -10/3.0)", Double.toString(Math.pow(1, -10 / 3.0)), null }, //
