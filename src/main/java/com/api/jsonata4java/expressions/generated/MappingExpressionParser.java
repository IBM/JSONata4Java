...
public class MappingExpressionParser extends Parser {
	...
	public static final int
		...
		GE=40, CONCAT=41, CIRCUMFLEX=42, PIPE=43, UNDER=44, AND=45, OR=46, VAR_ID=47, 
		ID=48;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"NOT_EQ", "LT", "LE", "GT", "GE", "CONCAT", "CIRCUMFLEX", "PIPE", "UNDER", 
			"AND", "OR", "VAR_ID", "ID"
		};
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((_la) & ~0x3f) == 0 && ((1L << _la) & 422224342016032L) != 0) {
					{
					setState(38);
					exprOrSeqList();
					}
	...
	public final RegexPatternContext regexPattern() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 562947805937662L) != 0) {
				{
				setState(253);
				_errHandler.sync(this);
